  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-[#0a0a0f]">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-1/3 left-1/3 w-96 h-96 bg-indigo-500/8 rounded-full blur-3xl" />
      </div>
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        >
          ...
          <div>
            <label htmlFor="name" className="block text-xs font-medium text-white/50 mb-2 uppercase tracking-wider">
              Name
            </label>
            <input
              id="name"
